package com.mikaela.hhtimer.adapter;
...
public class AppListAdapter extends BaseAdapter {
    ...
    public AppListAdapter(Activity instance, List<PackageInfo> installedList, ArrayList<String> checkedList) {
        ...
        System.out.println("AppListAdapter Constructor");
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mInstance).inflate(R.layout.list_item, null);
